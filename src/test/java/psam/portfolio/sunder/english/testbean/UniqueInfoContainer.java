...
public class UniqueInfoContainer {
    ...
    @Builder
    public UniqueInfoContainer(int numVal, int userNameLen, int userEmailLen, String emailDom, int academyNameMinLen, int academyNameMaxLen) {
