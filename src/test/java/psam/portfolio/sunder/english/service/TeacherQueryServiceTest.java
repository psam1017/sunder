...
public class TeacherQueryServiceTest extends AbstractSunderApplicationTest {
    ...
    void getTeacherListByTeacher(){
        ...
        // when
        List<?> result = refreshAnd(() -> sut.getList(director.getUuid(), cond));
    ...
    void getTeacherListByStudent(){
        ...
        // when
        List<?> result = refreshAnd(() -> sut.getList(student.getUuid(), cond));
    ...
    void getTeacherDetailByTeacher(){
        ...
        // when
        Object result = refreshAnd(() -> sut.getDetail(director.getUuid(), director.getUuid()));

        // then
        TeacherFullResponse teacherFullResponse = (TeacherFullResponse) result;
        assertThat(teacherFullResponse.getId()).isEqualTo(director.getUuid());
    ...
    void getTeacherDetailByStudent(){
        ...
        // when
        Object result = refreshAnd(() -> sut.getDetail(student.getUuid(), director.getUuid()));

        // then
        TeacherPublicResponse teacherPublicResponse = (TeacherPublicResponse) result;
        assertThat(teacherPublicResponse.getId()).isEqualTo(director.getUuid());
