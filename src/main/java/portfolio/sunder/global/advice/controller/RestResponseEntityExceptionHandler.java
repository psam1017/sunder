...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     */
    private String writeJson(ApiResponse<?> body) {
        try {
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                ...
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.METHOD_NOT_ALLOWED, message);

        return new ResponseEntity<>(writeJson(body), METHOD_NOT_ALLOWED);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                ...
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.UNSUPPORTED_MEDIA_TYPE, message);

        return new ResponseEntity<>(writeJson(body), UNSUPPORTED_MEDIA_TYPE);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotAcceptable(HttpMediaTypeNotAcceptableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                .append("Unable to negotiate. Acceptable media types are ")
                .append(ex.getSupportedMediaTypes())
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.NOT_ACCEPTABLE, message);

        return new ResponseEntity<>(writeJson(body), NOT_ACCEPTABLE);
    }
    ...
    protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                .append("required path variable '")
                .append(ex.getVariableName())
                .append("' is missing.")
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.BAD_REQUEST, message);

        return new ResponseEntity<>(writeJson(body), BAD_REQUEST);
    }
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(ServletRequestBindingException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ApiResponse<String> body = ApiResponse.of(ApiStatus.PRECONDITION_REQUIRED, message);

        return new ResponseEntity<>(writeJson(body), PRECONDITION_REQUIRED);
    }
    ...
    protected ResponseEntity<Object> handleHandlerMethodValidationException(HandlerMethodValidationException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return new ResponseEntity<>(writeJson(body), INTERNAL_SERVER_ERROR);
    }
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                .append("There is no API(or handler) for ")
                .append(ex.getHttpMethod())
                .append(" /")
                .append(ex.getRequestURL())
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.NOT_FOUND, message);

        return new ResponseEntity<>(writeJson(body), NOT_FOUND);
    }
    ...
    protected ResponseEntity<Object> handleNoResourceFoundException(NoResourceFoundException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                .append("There is no API(or resource) for ")
                .append(ex.getHttpMethod())
                .append(" /")
                .append(ex.getResourcePath())
                .toString();
        ApiResponse<String> body = ApiResponse.of(ApiStatus.NOT_FOUND, message);
    ...
    protected ResponseEntity<Object> handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return new ResponseEntity<>(writeJson(body), SERVICE_UNAVAILABLE);
    }
    ...
    protected ResponseEntity<Object> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        String message = new StringBuilder()
                .append("You exceeded max upload size. max = ")
                .append(ex.getMaxUploadSize() / 1024 / 1024)
                .append("MB")
                .toString();
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return new ResponseEntity<>(writeJson(body), new HttpHeaders(), BAD_REQUEST);
    }
