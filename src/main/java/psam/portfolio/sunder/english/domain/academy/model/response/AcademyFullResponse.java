...
public class AcademyFullResponse {
    ...
    public static AcademyFullResponse from(Academy academy) {
        return AcademyFullResponse.builder()
                ...
                .street(academy.getAddress() != null ? academy.getAddress().getStreet() : null)
                .addressDetail(academy.getAddress() != null ? academy.getAddress().getDetail() : null)
                .postalCode(academy.getAddress() != null ? academy.getAddress().getPostalCode() : null)
