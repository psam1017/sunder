...
public class StudySlicingSearchCond extends SlicingSearchCond {
    ...
    public StudySlicingSearchCond(Integer size, Long lastSequence, LocalDateTime startDateTime, LocalDateTime endDateTime, String studyTitle, String studentName, Integer schoolGrade) {
