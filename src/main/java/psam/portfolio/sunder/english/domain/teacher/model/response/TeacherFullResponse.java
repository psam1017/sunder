...
public class TeacherFullResponse {
    ...
    public static TeacherFullResponse from(Teacher teacher) {
        return TeacherFullResponse.builder()
                ...
                .street(teacher.getAddress() != null ? teacher.getAddress().getStreet() : null)
                .addressDetail(teacher.getAddress() != null ? teacher.getAddress().getDetail() : null)
                .postalCode(teacher.getAddress() != null ? teacher.getAddress().getPostalCode() : null)
